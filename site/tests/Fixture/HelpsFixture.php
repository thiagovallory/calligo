 ...
 * HelpsFixture
 */
class HelpsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'subject_help_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'fk_helps_subject_helps1_idx' => ['type' => 'index', 'columns' => ['subject_help_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2021-05-31 17:09:03',
                'modified' => '2021-05-31 17:09:03',
                'type' => 1,
                'subject_help_id' => 1,
            ],
        ];
