...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'active' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'created' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => true, 'default' => null, 'comment' => ''],
        'modified' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => true, 'default' => null, 'comment' => ''],
        'hash_active' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'role' => 1,
                'active' => 1,
                'created' => '2021-05-24 17:29:55',
                'modified' => '2021-05-24 17:29:55',
                'hash_active' => 'Lorem ipsum dolor sit amet',
            ],
        ];
        parent::init();
    }
