...
class ComplaintsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_complaints_users1_idx' => ['type' => 'index', 'columns' => ['therapist_id'], 'length' => []],
            'fk_complaints_users2_idx' => ['type' => 'index', 'columns' => ['patient_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'therapist_id' => 1,
                'patient_id' => 1,
                'created' => '2021-08-30 16:13:29',
                'modified' => '2021-08-30 16:13:29',
            ],
        ];
        parent::init();
    }
